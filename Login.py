...
class Login:
    ...
    def __init__(self):
        ...
        user_label = Label(frame, text="Username: ",font=myFont)
        pass_label = Label(frame, text="Password: ",font=myFont)
        space_label1 = Label(frame, text=" ")
        space_label2 = Label(frame, text=" ")
        user_entry = Entry(frame, width=17,font=myFont)
        pass_entry = Entry(frame,width=17,font=myFont, show='*')
        ...
        login_button = Button(frame, text="Login", padx=20, pady=7, bg="#4eb6b0", font=myFont, command=lambda: self.funzione(str(user_entry.get())))
        ...
        user_label2 = Label(frame, text="Username: ",font=myFont)
        pass_label2 = Label(frame, text="Password: ", font=myFont)
        space_label3 = Label(frame, text=" ")
        space_label4 = Label(frame, text=" ")
        user_entry2 = Entry(frame, width=17,font=myFont)
        pass_entry2 = Entry(frame, width=17,font=myFont)
        ...
        login_button2 = Button(frame, text="Register", padx=20, pady=7, bg="#1d434e", fg="white",font=myFont)
